...
<html>
 ...
 <body >
    	<form id="telphoneTypemsg" action="${ctx }/admin/service/telphoneTypeEdit" method="post">
  		<table>
  			<thead>
  			...
  			<tr>
  				...
  				<td>
  					<input class="easyui-combobox" id="pguid" style="width:200px;" name="telphoneType.pguid" data-options="editable:false,valueField:'guid',textField:'brandname',url:'${ctx }/admin/service/getBrandcombobox'" > 
  				</td>
  			</tr>
  		</table>
  		<div>
  ...
  $(function(){
	  $("#pguid").combobox({
			onLoadSuccess:function(){
				$("#pguid").combobox('setValue',"${telphoneType.pguid}")
			}
	  })
  })
  </script>
