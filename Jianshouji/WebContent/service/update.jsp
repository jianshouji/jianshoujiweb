...
<html>
 ...
 <body >
  	<form action="${ctx }/admin/service/phoneInsert">
  		<table>
  			<thead>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.batterytype"  style="width:200px;">   
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.fingerprint"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.isgyro"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.iscompase"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.ishallsenser"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.islightsenser"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.isgyroscope"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.isinfrared"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.isgps"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.isagps"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  			...
  			<tr>
  				...
  				<td>
  					<select class="easyui-combobox deflag" name="telphone.isgnonass"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select> 
  				</td>
  		...
  		<div>
  			<input style="" type="submit" id="submit_btn" value="确定">
  			<input type="reset" id="cancel_btn" value="重置">
  			<input style="" type="submit" id="close_btn" value="关闭">
  		</div>
  	</form>
 </body>
</html>
