...
<html>
 ...
 <body >
    	<form id="testmsg" action="${ctx }/admin/service/cepingInsert" method="post">
  		<table>
  			<thead>
  			...
  			<tr>
  				...
  				<td>
<%--   					  <select class="easyui-combobox" name="ceping.testflag"  style="width:200px;">   
    				<option value="1">是</option>   
    				<option value="0">否</option>   
					</select>  --%>
					<input type="text"  style="width:200px;" name="ceping.testflag"  value="0">
  				</td>
  			</tr>
  		</table>
  		<div>
